...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Grih-Chhaya</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Find Rental House Nearby</div>
          <div class="intro-heading text-uppercase">A Shade of Home, Wherever You Go!<br></div>
        </div>
      </div>
    </header>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">&copy; Grih-Chhaya (A Shade of Home, Wherever You Go) - <?php echo date("Y"); ?></span>
          </div>
          <div class="col-md-4">
